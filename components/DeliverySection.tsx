...
export const DeliverySection: React.FC = () => {
  return (
    <section id="entrega" className="py-24 bg-brand-dark text-white border-t border-brand-red/20 relative">
      {/* Top Gradient Overlay for smooth transition */}
      <div className="absolute top-0 left-0 w-full h-48 bg-gradient-to-b from-brand-light/5 to-transparent pointer-events-none"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row gap-16 mb-24 items-start">
          ...
          <div className="lg:w-1/2 order-2 lg:order-1">
            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-brand-light">
              Lorem Ipsum
            </h2>
            <p className="text-lg text-gray-300 mb-10 leading-relaxed border-l-4 border-brand-green pl-6">
          ...
          <div className="lg:w-1/2 relative order-1 lg:order-2">
             <div className="absolute inset-0 bg-brand-red rounded-2xl rotate-3 transform translate-x-4 translate-y-4 z-0 opacity-50"></div>
             
             <div className="relative z-10 w-full">
                {/* 
                  IMPORTANT: Only pass the ID "u7iH2dRmwDQ", NOT the full URL.
                  The start time is passed as a number (4 seconds).
                */}
                <VideoPlayer 
                  videoId="u7iH2dRmwDQ" 
